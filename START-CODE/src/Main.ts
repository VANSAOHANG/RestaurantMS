...
saoSauth.hr.addStaff(vichetChef,TimChef,sophiemChef);
saoSauth.hr.addStaff(waiter1,waiter2);
...
let item2 = new Dessert('Somlor Korko',1,5000);
...
saoSauth.order.makeOrder(order2);

c(saoSauth.cashier.calculateBill(1,order1));

saoSauth.debitQuantityItem();
